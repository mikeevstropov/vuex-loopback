...
Created Vuex module has [the state](#state) of single document and a document list. The following fields will contain data when you *get*, *create* or *update* a single item.
